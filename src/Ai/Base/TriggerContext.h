...
public:
    TriggerContext()
    {
        ...
        creators["enemy vehicle near"] = &TriggerContext::enemy_vehicle_near;
...
private:
    ...
    static Trigger* enemy_vehicle_near(PlayerbotAI* botAI) { return new EnemyVehicleNearTrigger(botAI); }
